...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-crown", "Use the experimental Crown successor chain. Equivalent to -chain=crown.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::CROWN:
        return std::make_unique<CBaseChainParams>("crown", 28443);
    }
    assert(false);
}
